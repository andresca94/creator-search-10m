...
def build_parser() -> argparse.ArgumentParser:
    ...
    s = sub.add_parser("search", help="Retrieve candidates from OpenSearch, rerank, and return Top-K with explanations.")
    ...
    e = sub.add_parser("eval", help="Offline eval on evalset.jsonl")
    ...
    l = sub.add_parser("latency", help="Benchmark p50/p95 latency over N requests")
